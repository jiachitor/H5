...
var config_tpl_browserSync = require('../config_tpl').browserSync;
...
gulp.task('browserSync_int', function () {
    browserSync({
...
gulp.task('browserSync_wh', function () {
    browserSync({
        browser: config_browserSync.browser,
        port: config_browserSync.port,
        server: {
...
gulp.task('browserSync_tpl', function () {
    browserSync({
        browser: config_tpl_browserSync.browser,
        port: config_tpl_browserSync.port,
        server: {
            baseDir: config_tpl_browserSync.server.baseDir,
            middleware: [
                require('compression')(),
                function (req, res, next) {
                    var urlObj = url.parse(req.url);
