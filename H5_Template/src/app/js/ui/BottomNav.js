...
var AutoPrefix = require('../../../../node_modules/material-ui/lib/styles/auto-prefix');
...
var Menu = require('../../../../node_modules/material-ui/lib/menu/menu');
...
var rightNav = React.createClass({
  ...
  propTypes: {
    ...
    openBottom: React.PropTypes.bool,
  ...
  getTheme: function getTheme() {
    this.context.muiTheme.component.bottomNav = {
      height:window.document.body.clientHeight * this.props.heightPercentage
    };
    return this.context.muiTheme.component.bottomNav;
  },

  getStyles: function getStyles() {
    var y = this._getTranslateMultiplier() * (this.state.open ? 0 : this._getMaxTranslateX()) + 'px';
    var styles = {
      root: {
        width: '100%',
    ...
    this.props.openBottom ? (styles.root.bottom = 0) : (styles.root.top = 0);
    ...
    return React.createElement(
      ...
      React.createElement(
        Paper,
        {
          ...
          rounded: false,
          transitionEnabled: !this.state.swiping,
          style: this.mergeAndPrefix(styles.root, this.props.openBottom && styles.rootWhenOpenRight, this.props.style) },
        this.props.header,
  ...
  _getTranslateMultiplier: function _getTranslateMultiplier() {
    return this.props.openBottom ? 1 : -1;
  },
  ...
  _onBodyTouchMove: function _onBodyTouchMove(e) {
    ...
    if (this.state.swiping) {
      ...
      var rightNav = React.findDOMNode(this.refs.clickAwayableElement);
      rightNav.style[AutoPrefix.single('transform')] = 'translate3d(' + this._getTranslateMultiplier() * translateX + 'px, 0, 0)';
