...
module.exports = {
    ...
    submit: function (params) {
        var self = this;
        return ajax.post('/admin/api/screenad', {
            data: params,
            headers: {
    ...
    update: function (params) {
        var self = this;
        return ajax.post('/admin/api/screenad/update', {
            data: params,
            headers: {
                'Session-Token': self.getToken()
            }
    ...
    load: function (params) {
        var self = this;
        return ajax.get('/admin/api/screenad/list.json', {
            data: params,
            headers: {
                'Session-Token': self.getToken()
            }
    ...
    delete: function (params) {
        var self = this;
        return ajax.post('/admin/api/screenad/delete', {
            data: params,
            headers: {
                'Session-Token': self.getToken()
            }
